...
Measurement problem / problem of time / horizon homogeneity & Interpretive or organizational synthesis & Record algebras, modular flow, and MaxEnt isotropy motivate these closures, but this wrapper does not upgrade them to the recovered-core tier of the compact note. \\
...
Cosmological constant & Phase II input-dependent corollary & \(\Lambda\) is tied to global screen capacity once the screen-capacity identification is adopted; this is not a local recovered-core output. \\
...
Proton stability / proton spin fraction & Mixed: Phase I / Phase III & No gauge-mediated proton decay follows from the realized product-group branch; proton-spin accounting via Casimir weighting remains a later continuation. \\
...
Three generations / Koide structure & Mixed: Phase I / Phase III & \(N_g=3\) is recovered on the realized MAR-admissible branch; Koide and charged-lepton fits require extra flavor ans\"atze. \\
Black-hole information & Program-level structural continuation & Edge-center sectorization and recoverability suggest an internal resolution, but the full black-hole branch is not part of Phase I. \\
