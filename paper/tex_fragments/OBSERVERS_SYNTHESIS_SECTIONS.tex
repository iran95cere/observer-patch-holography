...
\paragraph{Theorem (Gauge quotient and ancilla-stable physical uniqueness).}
...
refinement does not change the physical output.
...
lifted dynamics, so gauge-invariant observables are unchanged.
...
\item Physical UV uniqueness is quotient-level and ancilla-stable: the physical branch is fixed
