...
uniqueness theorem is quotient-level and ancilla-stable: gauge-covariant repair fixes the
physical branch modulo implementation hiding and inert ancillary refinement, not one microscopic
screen presentation. The microphysics paper is
...
lift plus the transportable compact-gauge lift remain behind the explicit T4/T8 and
T7/T10--T12 boundaries. The genuinely noncentral topological case points to a higher-gauge
crossed-module extension rather than an ordinary-group patch.
