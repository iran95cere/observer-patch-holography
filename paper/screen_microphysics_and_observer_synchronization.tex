...
\textbf{Non-goals.}
\begin{enumerate}[leftmargin=2em]
\item Do not claim that a unique microscopic UV completion is known; under the current OPH
axioms, inert ancillary refinements already leave the physical branch unchanged.
...
invariant here; the current OPH theorem surface fixes only the physical branch modulo gauge or
