...
The formalism is the computational spine of Observer-Patch Holography (OPH), a framework from which general relativity, the Standard Model gauge group $\mathrm{SU}(3)\times\mathrm{SU}(2)\times\mathrm{U}(1)/\mathbb{Z}_6$, and the string-theoretic worldsheet expansion have been derived as emergent sectors. The full OPH manuscript is available at \url{https://oph-book.lovable.app/papers/observers_are_all_you_need.pdf}.
\end{abstract}
