...
| $Q$ (Koide ratio) | $2/3$ | inline | The $\mathbb{Z}_3$ mode balance on generation space: the circulant Hermitian matrix $\Phi = a I + b P + b^* P^2$ on 3 generations satisfies $Q = (1 + 2\lvert b/a \rvert^2)/3 = 2/3$ when $\lvert b/a \rvert = 1/\sqrt{2}$, i.e., when the singlet and charged $\mathbb{Z}_3$ modes have equal norm. This is the MaxEnt equilibrium. | Theorem 13.2 (§13 of TECHNICAL_SUPPLEMENT.md) |
