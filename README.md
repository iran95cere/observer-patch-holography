...
> **Personal note (fork):** I'm working through Paper 2 and Paper 3 in parallel. My reading notes and margin questions are tracked in [`notes/reading_log.md`](notes/reading_log.md) — added that file to this fork for my own reference.
